...
/* ============================================================
   LEVEL ENGINE
   KURAL: HARCAMA VARSA → LEVEL ARTSIN
============================================================ */
exports.LevelEngine = onRequest(async (req, res) => {
  ...
  try {
    await db.runTransaction(async (trx) => {
      ...
      trx.update(userRef, {
        vbTotalSent: admin.firestore.FieldValue.increment(amt),
    ...
    console.error("LevelEngine_ERROR:", err.message);
